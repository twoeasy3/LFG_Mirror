...
import { SessionDataResponse, Session, getHostedSessions } from '../bin/SessionLogic';
...
function ViewHostedSessions() {
  ...
  return (
    <div className='bg-hero bg-cover bg-center min-h-screen'>
        <Sidebar buttons={["View All Sessions", "Create Session", "View Joined Sessions", "View Requests", "My Profile"]} />
        <Topbar/>
        <div className = "justify-center items-center flex">
            ...
            <div className="flex items-center justify-between mb-4">
                ...
                {sessCount !== 0 ? (
                  ...
                  <div className='LOADING_PLACEHOLDER fixed left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2'>You have not hosted any session</div>
                )}
            </div>
        </div>
    </div>
...
export default ViewHostedSessions;